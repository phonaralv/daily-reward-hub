...
import { RedeemCodeForm } from "@/features/referral/RedeemCodeForm";
import { ReferralList } from "@/features/referral/ReferralList";
...
export const Route = createFileRoute("/refer")({
  head: () => ({
    meta: [
      { title: "친구 추천 — Phonara" },
      { name: "description", content: "친구를 초대하고 검증된 보상을 받으세요." },
    ],
  }),
  component: () => (
